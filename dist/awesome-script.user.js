...
// @downloadURL https://github.com/Sympath/baolihou/blob/main/dist/awesome-script.user.js
// @grant       GM_addStyle
// ==/UserScript==
...
(function (web, solidJs, ui) {
  ...
  var styles = {
    title: 'style-module_title__04CU7',
    body: 'style-module_body__8uL-5',
    count: 'style-module_count__cBFXn',
    plus1: 'style-module_plus1__fsYU8',
    mockApiList: 'style-module_mockApiList__48OdH',
    mockApiItem: 'style-module_mockApiItem__n2lMS',
  };
  var stylesheet =
  ...
  var _tmpl$ = /*#__PURE__*/ web.template(`<div>`),
    _tmpl$2 = /*#__PURE__*/ web.template(
      `<div><div>snapshot mock<button>关闭mock</button></div><div>`,
    );
